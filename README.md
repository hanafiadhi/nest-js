...
iam using swagger for api docmentation

after running app check [click](http://localhost:3000/api)

tutor Link [click](https://docs.nestjs.com/openapi/introduction)
